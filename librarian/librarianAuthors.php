<?php include '../librarian/librarianHeader.php'; ?>
	...
	<h1>Authors
		<form method="post" class="frmAuthors">
			...
			<input type='text' id="authorSearch" name="authorSearch" placeholder="Search Authors" class="authorSearch">
			<button id="btnAuthorSearch" name="btnAuthorSearch" class="btn btn-secondary btnAuthorSearch">&#128269</button>
		</form>
	</h1>
	<form method="post">
